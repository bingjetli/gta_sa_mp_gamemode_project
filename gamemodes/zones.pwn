...
static PlayerText:textdraw_zone_name[MAX_PLAYERS];
 
forward zones_SetPlayerCurrentZone();
//---------------------------------------------------------------------------------------------------
...
stock zones_OnGameModeInit(){
	SetTimer("zones_SetPlayerCurrentZone", 1000, true);
}

stock zones_OnPlayerConnect(playerid){
	textdraw_zone_name[playerid] = CreatePlayerTextDraw(playerid, 90.0, 430.0, "current zone");
	...
	PlayerTextDrawLetterSize(playerid, textdraw_zone_name[playerid], 0.5, 2);
	PlayerTextDrawShow(playerid, textdraw_zone_name[playerid]);
	return 1;
}

public zones_SetPlayerCurrentZone(){
	static zone_name[MAX_ZONE_NAME];
	for(new i; i < MAX_PLAYERS; i++){
		if(IsPlayerConnected(i) == 1){
			GetPlayer2DZone(i, zone_name, MAX_ZONE_NAME);
			PlayerTextDrawSetString(i, textdraw_zone_name[i], zone_name);
		}
	}
}
