...
stock statusfx_OnPlayerConnect(playerid){
	...
	for(new i; i < MAX_VISIBLE_STATUSFX; i++){
		textdraw_active_statusfx[playerid][i] = CreatePlayerTextDraw(playerid, 550.0, 425.0 - (i*20.0), "statusfx    :99s");
		...
		PlayerTextDrawTextSize(playerid, textdraw_active_statusfx[playerid][i], 630.0, 1.0);
